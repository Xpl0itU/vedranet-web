...
function calculatePrices(
  ...
  if (cloudComputer) {
    if (cloudComputerBasicSetting === "Básico") finalPrice += 15;
    else if (cloudComputerBasicSetting === "Medio") finalPrice += 20;
    else if (cloudComputerBasicSetting === "Avanzado") finalPrice += 25;
  }

  if (physicalComputer) finalPrice += 20;
...
function Configurator() {
  ...
  const [cloudComputerBasicSetting, setCloudComputerBasicSetting] =
    useState("Medio");
  ...
  return (
    <div>
        ...
        <>
          <Box sx={{ maxWidth: 160 }}>
            <FormControl fullWidth>
              <InputLabel id="cloud-computer-basic-select-label">
                Características
              </InputLabel>
              <Select
      ...
      <div className="snapToBottom">
        ...
        <Typography>
          Equipo en la nube: {cloudComputer ? "Sí" : "No"}
        </Typography>
        {cloudComputer ? (
          <>
            <Typography>
              Perfil de características: {cloudComputerBasicSetting}
            </Typography>
          </>
        ) : null}
